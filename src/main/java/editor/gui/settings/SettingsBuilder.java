...
public class SettingsBuilder
{
    ...
    public Settings build()
    {
        return new Settings(
            ...
            inventoryUpdate,
            inventoryWarn,
            CollectionConverters.asScala(inventoryColumns).toSeq(),
            inventoryBackground,
            inventoryStripe,
            recentsCount,
            CollectionConverters.asScala(recentsFiles).toSeq(),
            explicits,
            CollectionConverters.asScala(presetCategories).toSeq(),
            categoryRows,
            CollectionConverters.asScala(editorColumns).toSeq(),
            editorStripe,
            handSize,
            handRounding,
            handBackground,
