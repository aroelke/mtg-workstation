 ...
 * @author Alec Roelke
 */
class PhyrexianSymbol private[symbol](val color: ManaType) extends ManaSymbol(s"phyrexian_${color.toString.toLowerCase}_mana.png", s"${color.shorthand.toUpper}/P", 1, PhyrexianSymbolGenerator) {
